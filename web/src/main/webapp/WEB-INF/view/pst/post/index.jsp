...
<script>
    var table_cols=[[
        {field: 'pk_post', title: '主键'},
        {field: 'title', title: '主题'},
        {field: 'content', title: '内容'},
        {field: 'photo', title: '图片'},
        {field: 'photoposi', title: '图片位置'},
    ...
    function doSave(data) {
        ...
        var result=httpPost('/ww/pst/post/save',JSON.stringify(aggVO));
        if(result!=null)
            layer.msg(result.msg);
    };

    function doDelete(selecteddata) {
        var result=httpPost('/ww/pst/post/delete',JSON.stringify(selecteddata));
        if(result!=null)
            layer.msg(result.msg);
    };

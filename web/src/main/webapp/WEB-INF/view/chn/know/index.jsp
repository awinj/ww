...
<script>
    var table_cols=[[
        {field: 'pk_know', title: '主键',hide:true},
    ...
    function doSave(data) {
        ...
        var result=httpPost('/ww/chn/know/save',JSON.stringify(aggVO));
        if(result!=null)
            layer.msg(result.msg);
    };

    function doDelete(selecteddata) {
        var result=httpPost('/ww/chn/know/delete',JSON.stringify(selecteddata));
        if(result!=null)
            layer.msg(result.msg);
    };

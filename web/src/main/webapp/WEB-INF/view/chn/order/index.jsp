...
<script>
    var table_cols=[[
        {field: 'pk_order', title: '主键', hide:true},
        {field: 'title', title: '标题', },
        {field: 'memeo', title: '备注', },
    ...
    function doSave(data) {
        ...
        var result=httpPost('/ww/chn/order/save',JSON.stringify(aggVO));
        if(result!=null)
            layer.msg(result.msg);
    };

    function doDelete(selecteddata) {
        var result=httpPost('/ww/chn/order/delete',JSON.stringify(selecteddata));
        if(result!=null)
            layer.msg(result.msg);
    };

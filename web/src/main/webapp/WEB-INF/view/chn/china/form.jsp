...
<div id="formdiv" class="formdiv">
    ...
    <form class="layui-form winadmin" id="formpanl" action="" lay-filter="form_filter">
        ...
        <div class="layui-form-item"><label class="layui-form-label">关键词</label>
            <div class="layui-input-inline"><input name="keyword" class="layui-input" style="width:600px" type="text" placeholder="请输入关键词"
                                                   value="" autocomplete="off" lay-verify="keyword"/></div>
        </div>
        <div class="layui-form-item"><label class="layui-form-label">简介</label>
            <div class="layui-input-block"><textarea name="memo" class="layui-textarea" type="text" placeholder="请输入简介" value="" autocomplete="off"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input name="creator" disabled="disabled" class="layui-input" type="text" placeholder="请输入创建人" value=""
        ...
        <div class="layui-form-item">
            <div class="layui-inline"><label class="layui-form-label">修改人</label>
                <div class="layui-input-inline"><input name="modifier" disabled="disabled" class="layui-input" type="text"
                                                        value="" autocomplete="off" ref="user"
                                                       lay-verify="modifier"/></div>
            </div>
            <div class="layui-inline"><label class="layui-form-label">修改时间</label>
                <div class="layui-input-inline"><input name="modifyTime" disabled="disabled" class="layui-input" type="text"

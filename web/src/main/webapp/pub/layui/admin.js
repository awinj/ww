...
;layui.define("view", function (e) {
        ...
        flexible: function (e) {
            ...
            k.note.index = C.popup({
                ...
                success: function (e, a) {
                    var i = e.find("textarea"), l = void 0 === t ? "便签中的内容会存储在本地，这样即便你关掉了浏览器，在下次打开时，依然会读取到上一次的记录。是个非常小巧实用的本地备忘录" : t;
            ...
            var i = a("#LAY_app_tabsheader"), n = i.children("li"), l = (i.prop("scrollWidth"), i.outerWidth()), s = parseFloat(i.css("left"));
            if ("left" === e) {
                if (!s && s <= 0)return;
                var r = -s - l;
                n.each(function (e, t) {
    ...
    !function () {
        ...
        var t = e.path, i = function (e) {
            ...
            e.each(function (e, s) {
                var r = a(s), o = i(r), u = o.list.children("dd"), c = t[0] == o.name || 0 === e && !t[0] || o.jump && n == C.correctRouter(o.jump);
                if (u.each(function (e, s) {
                        var r = a(s), u = i(r), c = u.list.children("dd"), y = t[0] == o.name && t[1] == u.name || u.jump && n == C.correctRouter(u.jump);
                        if (c.each(function (e, s) {
                                var r = a(s), c = i(r), y = t[0] == o.name && t[1] == u.name && t[2] == c.name || c.jump && n == C.correctRouter(c.jump);
                                if (y) {
                                    var m = c.list[0] ? l : d;

...
public class BeanHelper {
    ...
    public static List<String> getPropertys(Class clss) {
        return Arrays.asList(getInstance().getPropertiesAry(clss));
    }
     ...
     */
    public String[] getPropertiesAry(Class clss) {
        ReflectionInfo reflectionInfo ;
        this.rwl.readLock().lock();
        try {
            reflectionInfo = cachedReflectionInfo(clss);
    ...
    public String[] getPropertiesAry(Object bean) {
        return  getPropertiesAry(bean.getClass());
    }
...
//            Object ret=method.invoke(bean, NULL_ARGUMENTS);
    ...
    public static <T> T createBean(Class<T> c)
    {
        try {
